        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    ...
                    BattingAverage = table.Column<decimal>(type: "TEXT", nullable: false),
                    StrikeRate = table.Column<decimal>(type: "TEXT", nullable: false),
                    Centuries = table.Column<int>(type: "INTEGER", nullable: false),
                    Fifties = table.Column<int>(type: "INTEGER", nullable: false),
                    Wickets = table.Column<int>(type: "INTEGER", nullable: false),
                    BowlingAverage = table.Column<decimal>(type: "TEXT", nullable: false),
                    EconomyRate = table.Column<decimal>(type: "TEXT", nullable: false),
                    FiveWicketHauls = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Players_ViceCaptainId",
